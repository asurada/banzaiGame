...
@implementation HuangjinSihei




+(id)spriteWithFile{
    return [super spriteWithSpriteFrameName:@"HuangjinSihei_normal_1.png"];
}
...
-(void)loadDeadAnim{
    self.deadSound = @"fingerHit_2.caf";
    NSMutableArray *deadAnimFrames = [NSMutableArray array];
    for (int i=1; i<=56; i++) {
        [deadAnimFrames addObject:
         [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:
          [NSString stringWithFormat:@"HuangjinSihei_dead_%d.png",i]]];
    }
...
-(void)loadNormalAnim{
    ...
    for (int i=1; i<=14; i++) {
        [normalAnimFrames addObject:
         [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:
          [NSString stringWithFormat:@"HuangjinSihei_normal_%d.png",i]]];
    }
