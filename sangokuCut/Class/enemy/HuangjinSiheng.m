...
@implementation HuangjinSiheng




+(id)spriteWithFile{
    return [super spriteWithSpriteFrameName:@"HuangjinSiheng_normal_1.png"];
}
...
-(void)loadDeadAnim{
    ...
    for (int i=1; i<=56; i++) {
        [deadAnimFrames addObject:
         [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:
          [NSString stringWithFormat:@"HuangjinSiheng_dead_%d.png",i]]];
    }
...
-(void)loadNormalAnim{
    ...
    for (int i=1; i<=14; i++) {
        [normalAnimFrames addObject:
         [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:
          [NSString stringWithFormat:@"HuangjinSiheng_normal_%d.png",i]]];
    }
